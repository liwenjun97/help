...
public class Unfinished_Order_3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view;
        view=inflater.inflate(R.layout.unfinish_help_buy,container,false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ordershow1 = (RecyclerView) getActivity().findViewById(R.id.unfinish_help_buy);
...
//目录监听事件
        adapter.setOnItemClickListener(new PullMoreRecyclerAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View itemView, int pos,int userid) {
                ...
                Intent intent=new Intent(getActivity(),Order_help_buy.class);
                ...
                if(json.optString("error")==""){
                    ...
                    if(json.optString("help")!=null){
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            Log.i("7", String.valueOf(j.optInt("helpId")));
