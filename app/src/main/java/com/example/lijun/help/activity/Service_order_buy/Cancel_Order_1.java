...
public class Cancel_Order_1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view;
        view=inflater.inflate(R.layout.kill_order_buy,container,false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ordershow1 = (RecyclerView) getActivity().findViewById(R.id.rv_kill_order_buy);
