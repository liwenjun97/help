...
public class Unfinished_Order_4 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view;
        view=inflater.inflate(R.layout.unfinish_help_my,container,false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ordershow1 = (RecyclerView) getActivity().findViewById(R.id.unfinish_help_my);
...
//目录监听事件
        adapter.setOnItemClickListener(new PullMoreRecyclerAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View itemView, int pos,int userid) {
                ...
                Intent intent=new Intent(getActivity(),Order_help_my.class);
