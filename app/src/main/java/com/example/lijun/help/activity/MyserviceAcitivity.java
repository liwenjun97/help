...
import com.example.lijun.help.activity.Service_order_my.Order_service_my;
...
public class MyserviceAcitivity extends AppCompatActivity{
    private Button back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back=(Button)findViewById(R.id.back_myservice);
        ...
        ordershow1 = (RecyclerView)findViewById(R.id.myservice);
...
//目录监听事件
        adapter.setOnItemClickListener(new PullMoreRecyclerAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View itemView, int pos,int userid) {
                ...
                Intent intent=new Intent(MyserviceAcitivity.this,MyserviceContent.class);
    ...
    private void getDatas() {
        ...
        url = "http://10.0.2.2:8082/Home/ServiceApi/displayServiceOwn";
        try {
        ...
        public void handleMessage(Message msg) {
            ...
            try {
                ...
                if(json.optString("error")==""){
                    Log.i("22", json.optString("service"));
                    if(json.optString("service")!=null){
                        JSONArray jsonArray =new JSONArray(json.optString("service"));

                        for(int i=0;i<jsonArray.length();i++) {
                            JSONObject j=(JSONObject)jsonArray.get(i);
                            if(j.optInt("uFinish")==0) {
