...
public class Cancel_Order_2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view;
        view=inflater.inflate(R.layout.kill_order_my,container,false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ordershow1 = (RecyclerView) getActivity().findViewById(R.id.rv_kill_order_my);
                ...
                if(json.optString("error")==""){
                    ...
                    if(json.optString("order")!=null){
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if(ufinish == 2&&j.optInt("idOwn")==User.uId) {
