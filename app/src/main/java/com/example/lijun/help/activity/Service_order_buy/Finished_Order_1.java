...
/**
 * Created by lijun on 2018/1/8.
 */

public class Finished_Order_1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view;
        view=inflater.inflate(R.layout.finished_order_buy,container,false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ordershow= (RecyclerView) getActivity().findViewById(R.id.re_finished_order_buy);
                ...
                if(json.optString("error")==""){
                    ...
                    if(json.optString("order")!=null){
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if(ufinish == 1&&j.optInt("uId")==User.uId) {
